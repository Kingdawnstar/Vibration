...
export default function AdminPanel({ 
  ...
  const [activeTab, setActiveTab] = useState<'lessons' | 'reviews' | 'curriculum'>('lessons');
          ...
          <div className="lg:col-span-2 space-y-6" id="editor_parent_panel">
            <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-6 shadow-sm">
              <div className="flex items-center justify-between border-b border-zinc-800 pb-4">
                <div>
                  <h2 className="text-lg font-serif italic text-white font-semibold">Publish Academy Lesson Node</h2>
              ...
              <form onSubmit={handlePublishPost} className="mt-6 space-y-5" id="post_creation_form">
                ...
                <div className="flex items-center justify-end space-x-3 pt-2">
                  ...
                  >
                    ...
                    <span>{isPublishing ? 'Publishing lesson...' : '🚀 Publish Academy Lesson'}</span>
                  </button>
                </div>
              </form>
            </div>
                    ...
                    >
                      ...
                      <div className="mt-3 flex items-center justify-end space-x-2 border-t border-zinc-850 pt-2.5">
                        <button
                          ...
                          className="flex items-center space-x-1 rounded bg-zinc-900 border border-zinc-800 px-2 py-1 text-[10px] font-semibold text-zinc-350 hover:text-white"
                        >
                        ...
                        <button
                          ...
                          className="flex items-center space-x-1 rounded bg-red-950/30 border border-red-900/40 px-2 py-1 text-[10px] font-semibold text-red-400 hover:bg-red-950/60"
                        >
