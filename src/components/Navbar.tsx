...
import { LogIn, LogOut, Bell, Shield, BookOpen, Music, Check, Sparkles } from 'lucide-react';
...
export default function Navbar({ user, isAdmin, onNavigateHome, onOpenAdmin, currentView }: NavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-zinc-800 bg-[#0A0A0A]/95 backdrop-blur-md text-zinc-100" id="main_header">
