...
export default function PostCard({ post, userLiked, onLikeToggle, onSelect }: PostCardProps) {
  ...
  return (
    <article 
      className="group relative flex flex-col overflow-hidden rounded-2xl border border-zinc-100 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md"
    ...
    >
      ...
      <div className="relative h-40 w-full overflow-hidden bg-gradient-to-br from-zinc-950 to-zinc-900 flex items-center justify-center">
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <h3 
          ...
          className="mt-3.5 cursor-pointer text-base font-bold tracking-tight text-zinc-900 line-clamp-2 transition-colors hover:text-orange-600"
        >
          {post.title}
        </h3>

        <p className="mt-2.5 flex-1 text-xs text-zinc-500 line-clamp-3">
        ...
        <div className="mt-5 flex items-center justify-between border-t border-zinc-100 pt-4">
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className={`flex items-center space-x-1.5 text-xs font-semibold focus:outline-none ${
                userLiked ? 'text-red-500' : 'text-zinc-400 hover:text-zinc-600'
              }`}
            >
            ...
            <button 
              onClick={() => onSelect(post)}
              className="flex items-center space-x-1.5 text-xs font-semibold text-zinc-400 hover:text-orange-600"
            >
          ...
          <div className="flex items-center space-x-1">
            <button
              ...
              className="rounded-full p-2 text-zinc-400 hover:bg-zinc-100 hover:text-zinc-950 focus:outline-none"
              title="Share Lesson"
            >
